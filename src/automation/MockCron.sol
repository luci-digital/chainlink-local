// Copy pasted from the @chainlink/contracts because of solidity versions incompatibility
...
import {DateTime} from "@chainlink/contracts/src/v0.8/vendor/DateTime.sol";
...
library CronExternal {
     ...
     * @return true / false if they match
     */
    function matches(Spec calldata spec, uint256 timestamp) public pure returns (bool) {
